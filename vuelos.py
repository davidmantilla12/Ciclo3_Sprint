...
class vuelo(FlaskForm): 
    ...
    hora_salida=TimeField('hora de salida', validators=[DataRequired("Llena este campo")],format='%H:%M',render_kw={"placeholder": "Hora de Salida"})
    hora_llegada=TimeField('hora de llegada', validators=[DataRequired("Llena este campo")],format='%H:%M',render_kw={"placeholder": "Hora de llegada"})
    ...
    asientos=StringField("asientos",validators=[DataRequired("Llena este campo")],render_kw={"placeholder": "Trama de asientos"})
